...
def test_empty_courses_list():
    ...
    with sync_playwright() as playwright:
        ...
        courses_title = page.get_by_test_id('navigation-navbar-app-title-text')
        expect(courses_title).to_be_attached()
        expect(courses_title).to_have_text('UI Course')
        ...
        empty_icon_element = page.get_by_test_id('courses-list-empty-view-icon')
        expect(empty_icon_element).to_be_attached()
        ...
        expect(description_text).to_be_attached()
